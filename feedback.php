...
<h2  align="center" style="font-family:'typo'; color:#000066"><b>FEEDBACK/REPORT A PROBLEM</b></h2>
</br>
<div style="font-size:15px">
<?php if(@$_GET['q'])echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;'.@$_GET['q'].'</span>';
else
{echo' 
<center>You can send us your feedback through e-mail on the following e-mail id:<br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:examaap@contact.in" style="color:#000000">examaap@contact.in</a><br /><br />
</div><div class="col-md-1"></div></div>
<p>Or you can directly submit your feedback by filling the enteries below:-</p></center></br>
...
<a href="http://www.github.com/aprenduaman" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/DP1.png" width=100 height=100 alt="Aprendu image" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://github.com/aprenduaman" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on GitHub">Aprendu Aman</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 6386492022</h4>
		<h4 style="font-family:'typo' ">aprenduaman1401gmail.com</h4>
